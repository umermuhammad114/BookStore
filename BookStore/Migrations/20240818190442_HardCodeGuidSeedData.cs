...
{
    /// <inheritdoc />
    public partial class HardCodeGuidSeedData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), null, "Librarian", null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), null, "Teacher", null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), null, "Student", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("44444444-4444-4444-4444-444444444444"), "AddBook" },
                    { new Guid("55555555-5555-5555-5555-555555555555"), "DeleteBook" },
                    { new Guid("66666666-6666-6666-6666-666666666666"), "GetBooks" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("66666666-6666-6666-6666-666666666666"), new Guid("33333333-3333-3333-3333-333333333333") }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { new Guid("66666666-6666-6666-6666-666666666666"), new Guid("33333333-3333-3333-3333-333333333333") });
